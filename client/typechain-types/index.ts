...
export type { Receptionist } from "./contracts/Receptionist";
export { Receptionist__factory } from "./factories/contracts/Receptionist__factory";
export type { Rooms } from "./contracts/Rooms";
export { Rooms__factory } from "./factories/contracts/Rooms__factory";
